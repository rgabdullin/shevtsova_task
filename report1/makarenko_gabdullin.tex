...
Учитывая, что $e^{\frac{-t^2}{2}} \le e^{-\frac{1}{18L^2}}, e^{\frac{-t^2}{4}} \le e^{-\frac{1}{36L^2}}$, при $|t| > \frac{1}{3L}$, получаем:

\[\int_{\frac{1}{3L} \le |t| \le \frac{1}{94L^3}} {\frac{1-94L^3|t|}{L^3|t|}\cdot (e^{-\frac{t^2}{2}} + e^{-\frac{t^2}{4}}) \, dt} \le \]
\[
\le
\int_{\frac{1}{3L} \le |t| \le \frac{1}{94L^3}} {\biggl(\frac{3}{L^2}-94\biggr)\cdot (e^{-\frac{1}{18L^2}} + e^{-\frac{1}{36L^2}}) \, dt}
\le
\]
\[
\le
\frac{3}{L^2} \cdot 2\biggl( \frac1{94L^3}-\frac1{3L} \biggr) \cdot (e^{-\frac{1}{18L^2}} + e^{-\frac{1}{36L^2}})
\le
\frac{3}{47} \cdot \frac1{L^5} \cdot (e^{-\frac{1}{18L^2}} + e^{-\frac{1}{36L^2}}) \longrightarrow 0
\]
